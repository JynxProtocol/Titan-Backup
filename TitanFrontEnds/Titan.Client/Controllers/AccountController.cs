...
namespace Titan.Client.Controllers
{
    ...
    {
        internal TitanAdmin TitanAdmin { get; private set; }

        public AccountController(TitanAdmin titanAdmin)
        {
        ...
        public async Task<ActionResult> Login(string User, string Password, string returnUrl)
        {
            try
            {
                LoginResponse loginResponse = await TitanAdmin.LoginAsync(new LoginRequest
                {
                    Username = User,
                    Password = Password
                });
        ...
        public async Task<ActionResult> ChangePassword(string username, string password,
            string newPassword, string newPasswordC)
        {
            // validate password
