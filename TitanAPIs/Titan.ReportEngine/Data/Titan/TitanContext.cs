...
using Titan.ReportEngine.Models.Titan;
...
namespace Titan.ReportEngine.Data
{
    public partial class TitanContext : DbContext
    {
        ...
        public virtual DbSet<ExperditeDetail> ExperditeDetails { get; set; }
        public virtual DbSet<ExperditeHeader> ExperditeHeaders { get; set; }
        public virtual DbSet<ExperditePL> ExperditePLs { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(Startup.Configuration.GetConnectionString("TITAN"));
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ExperditeDetail>(entity =>
            {
                entity.HasKey(e => e.EDID);

                entity.ToTable("ExperditeDetail");

                entity.Property(e => e.EDID).ValueGeneratedNever();
            ...
            modelBuilder.Entity<ExperditeHeader>(entity =>
            {
                entity.HasKey(e => e.ExperditeID);

                entity.ToTable("ExperditeHeader");

                entity.Property(e => e.ExperditeID).ValueGeneratedNever();

                entity.Property(e => e.DateCreated).HasColumnType("datetime");
            });

            modelBuilder.Entity<ExperditePL>(entity =>
            {
                entity.HasKey(e => e.EXID);

                entity.ToTable("ExperditePL");
