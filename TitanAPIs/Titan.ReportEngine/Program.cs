            ...
            HostFactory.Run(HostConfiguration =>
            {
               ...
               .CreateLogger();
                ...
                HostConfiguration.Service<WebAPIService>(ServiceConfiguaration =>
                {
                    ...
                    //ServiceConfiguaration.WhenStarted((s, hostControl) => s.Start(hostControl));
                    ...
                    //ServiceConfiguaration.WhenStopped((s, hostControl) => s.Stop(hostControl));
                ...
                HostConfiguration.SetDescription("Titan ReportEngine");
                HostConfiguration.SetDisplayName("Titan ReportEngine");
                HostConfiguration.SetServiceName("Titan ReportEngine");
            });
        }
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                .ConfigureWebHostDefaults(webBuilder =>
                {
                    ...
                    webBuilder.UseUrls("http://0.0.0.0:52289");
                });
