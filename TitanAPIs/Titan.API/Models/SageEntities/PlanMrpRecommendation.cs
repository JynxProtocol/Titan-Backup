...
{
    public partial class PlanMrpRecommendation
    {
        public PlanMrpRecommendation()
        {
            PlanMrpRecommendationsRoutings = new HashSet<PlanMrpRecommendationsRouting>();
        }
        ...
        public virtual Salutation BuyerCodeSalutation { get; set; }
        public virtual SYSCountryCode DelAddressCountry { get; set; }
        public virtual ICollection<PlanMrpRecommendationsRouting> PlanMrpRecommendationsRoutings { get; set; }
    }
}