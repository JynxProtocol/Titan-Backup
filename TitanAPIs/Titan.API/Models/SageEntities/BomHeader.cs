...
namespace Titan.API.Models
{
    public partial class BomHeader
    {
        public BomHeader()
        {
            BomAttachedDocuments = new HashSet<BomAttachedDocument>();
            BomComponents = new HashSet<BomComponent>();
            BomDrawing1s = new HashSet<BomDrawing1>();
            BomFinishedProducts = new HashSet<BomFinishedProduct>();
            BomOperation1s = new HashSet<BomOperation1>();
        }
        ...
        public virtual ICollection<BomAttachedDocument> BomAttachedDocuments { get; set; }
        public virtual ICollection<BomComponent> BomComponents { get; set; }
        public virtual ICollection<BomDrawing1> BomDrawing1s { get; set; }
        public virtual ICollection<BomFinishedProduct> BomFinishedProducts { get; set; }
        public virtual ICollection<BomOperation1> BomOperation1s { get; set; }
    }
}