...
{
    public partial class WorksOrderTracking
    {
        public WorksOrderTracking()
        {
            WorksOrderActualOpTimes = new HashSet<WorksOrderActualOpTime>();
        }
        ...
        public double? MachineChargeRate { get; set; }
        ...
        public decimal PlannedLabourCost { get; set; }
        public decimal PlannedMachineCost { get; set; }
        public decimal PlannedSetupCost { get; set; }
        public decimal PlannedToolingCost { get; set; }
        public decimal PlannedSubcontractCost { get; set; }

        public virtual WorksOrder Header { get; set; }
        public virtual ICollection<WorksOrderActualOpTime> WorksOrderActualOpTimes { get; set; }
    }
}